...
locals {
  ...
  cdn_environment_platform_domain           = "cdn.${local.environment_platform_domain}"
}
...
resource "aws_route53_record" "cdn_environment_platform_domain" {
  ...
  name    = local.cdn_environment_platform_domain
  type    = "A"
...
module "cdn_environment_platform_domain" {
  ...
  aliases = [local.cdn_environment_platform_domain]
...
# mcdaniel: this is common. nont environment-specific.
#
